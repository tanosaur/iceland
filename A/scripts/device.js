...
if (isMobile === true) {
  ...
  function orient(){
    ...
    document.getElementById('mobile-instruction').style.display = 'none';
  ...
  function toggle() {
    ...
    if (window.innerWidth < 830) {
      ...
      document.getElementsByTagName('h1')[0].style.fontSize = '28px';
      document.getElementsByTagName('h2')[0].style.fontSize = '28px';
      ...
      document.getElementById('container').style.paddingBottom = '20px';
        ...
        document.getElementsByTagName('h1')[0].style.fontSize = '26px';
        document.getElementsByTagName('h2')[0].style.fontSize = '26px';
        document.getElementById('count').style.fontSize = '12px';
        document.getElementById('left').appendChild(document.getElementById('count'));
        document.getElementById('left').style.display = 'block';
